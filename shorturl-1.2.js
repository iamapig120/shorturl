document.write('<form name="input" class="su_inp" >请输入长网址：<br><input style="width: 100%;" placeholder="例如https://www.bysb.net/" id="long" name="long" class="su_url" ><br><div id="link" class="su_link" ><p>生成的短网址：</p></div><br><a class="su_btn" href="javascript:shorturl()">点击这里生成</a><br><a class="su_edi" href="https://www.bysb.net/" target="_blank">作者：手柄君</a></form>');//生成整个表单
function shorturl() {
